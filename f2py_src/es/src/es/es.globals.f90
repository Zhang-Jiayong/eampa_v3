...
!# BP DATA
INTEGER(kind=StandardInteger) ::                        calc_configs_count = 0
INTEGER(kind=StandardInteger) ::                        calc_keys_i(1:100, 1:2) = -1
REAL(kind=DoubleReal) ::                                calc_keys_r(1:100, 1:2) = 0.0D0
INTEGER(kind=StandardInteger) ::                        calc_configs(1:100, 1:100) = 0

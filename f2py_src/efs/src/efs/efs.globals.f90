...
INTEGER(kind=StandardInteger) ::                        pkey_temp(1:max_configs, 1:6) = 0
INTEGER(kind=StandardInteger) ::                        pkey(1:max_configs, 1:6) = 0
REAL(kind=DoubleReal) ::                                pot_rcut(1:max_configs) = 0
...
REAL(kind=DoubleReal) ::                                rss_weights(1:3) = 1.0D0   
